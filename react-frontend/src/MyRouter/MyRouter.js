...
import SingleUserProfilePage from "../components/UserProfilePage/SingleUserProfilePage";
// ~cb-add-import~
        ...
        <Routes>
            ...
            <Route element={<ProtectedRoute redirectPath={'/login'} />}>
                <Route path="/account" exact element={<Account />} />
                    ...
                    <Route path="/userProfile/:singleUserProfileId" exact element={<SingleUserProfilePage />} />
